...
function updateUI() {
    ...
    if (stat === "win" && messageWin) messageWin.classList.remove("hidden");
    else if (stat === "lose" && messageLose) messageLose.classList.remove("hidden");
}
...
},{"../styles/main.scss":"bo7w8","../modules/Game.class":"eIbh2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bo7w8":[function() {},{}],"eIbh2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Game {
    constructor(initialState = null){
        ...
        if (initialState) {
            ...
            this.status = "playing";
        } else this.initEmptyBoard();
    }
    initEmptyBoard() {
        this.board = [];
        for(let r = 0; r < 4; r++)this.board.push([
            0,
            0,
            0,
            0
    ...
    slideAndMergeRow(row) {
        ...
        const mergedRow = [];
        let scoreGain = 0;
        for(let i = 0; i < filtered.length; i++)if (filtered[i] === filtered[i + 1] && filtered[i] !== 0) {
            const newValue = filtered[i] * 2;
            mergedRow.push(newValue);
            scoreGain += newValue;
            i++;
        } else mergedRow.push(filtered[i]);
    ...
    moveLeft() {
        ...
        for(let r = 0; r < 4; r++){
            ...
            if (JSON.stringify(this.board[r]) !== JSON.stringify(mergedRow)) moved = true;
    ...
    moveRight() {
        ...
        for(let r = 0; r < 4; r++){
            ...
            if (JSON.stringify(this.board[r]) !== JSON.stringify(finalRow)) moved = true;
    ...
    moveUp() {
        ...
        for(let c = 0; c < 4; c++){
            ...
            for(let r = 0; r < 4; r++){
                if (this.board[r][c] !== mergedRow[r]) moved = true;
    ...
    moveDown() {
        ...
        for(let c = 0; c < 4; c++){
            ...
            for(let r = 0; r < 4; r++){
                if (this.board[r][c] !== finalCol[r]) moved = true;
